...
/**
 * The react-native side of Confgo's {@link ConnectionService}. Exposes
 * the Java Script API.
 *
 * @author Pawel Domas
 */
...
class RNConnectionService extends ReactContextBaseJavaModule {
     ...
     *
     * @param callUUID - unique call identifier assigned by Confgo to
     *        a conference call.
     * @param handle - a call handle which by default is Confgo room's URL.
