...
Confgo uses [i18next](http://i18next.com) library for translation.
i18next uses separate json files for each language.


## Translating Confgo

The translation of Confgo is handled editing manually the language files.
...
If you want to add new functionality for Confgo and you have texts that need to be translated you must add key and value in main.json file in English for each translatable text.
