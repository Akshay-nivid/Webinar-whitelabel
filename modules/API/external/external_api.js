...
export default class JitsiMeetExternalAPI extends EventEmitter {
    /**
     * Constructs new API instance. Creates iframe and loads Confgo in it.
     *
    ...
    /**
     * Getter for the large video element in Confgo.
     *
    ...
    /**
     * Getter for the prejoin video element in Confgo.
     *
    ...
    /**
     * Getter for participant specific video element in Confgo.
     *
     ...
     * {@code readyToClose} - all hangup operations are completed and Confgo
    ...
    /**
     * Removes the listeners and removes the Confgo frame.
     *
     * @returns {void}
     */
    dispose() {
    ...
    /**
     * Returns the iframe that loads Confgo.
     *
