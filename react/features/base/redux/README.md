Confgo - redux state persistence
====================================
Confgo has a persistence layer that persists specific subtrees of the redux
...
When it's done, Confgo will automatically persist these subtrees and
