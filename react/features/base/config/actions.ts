...
/**
 * Signals that the configuration (commonly known in Confgo as config.js)
...
/**
 * Signals that a configuration (commonly known in Confgo as config.js)
...
/**
 * Stores a specific Confgo config.js object into {@code localStorage}.
 *
 * @param {string} baseURL - The base URL from which the config.js was
 * downloaded.
 * @param {Object} config - The Confgo config.js to store.
 * @returns {Function}
 */
