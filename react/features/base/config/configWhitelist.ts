...
export default [
     ...
     * provided by, for example, Confgo SDK for iOS.
     *
     * @type string
     */
    'callDisplayName',
     ...
     * override/overwrite provided by, for example, Confgo SDK for iOS.
     *
     * @type string
     */
    'callHandle',
     ...
     * which Confgo is to work with a CallKit call created outside of Jitsi
     * Meet and to be adopted by Confgo such as, for example, an incoming
     * and/or outgoing CallKit call created by Confgo SDK for iOS
     * clients/consumers prior to giving control to Confgo. As the value is
     * associated with a conference/meeting, the value makes sense not as a
     * deployment-wide configuration, only as a runtime configuration
     * override/overwrite provided by, for example, Confgo SDK for iOS.
     *
